...
class Recharge extends React.Component {
  ...
  fetch = (phone,beginTime,endTime,currentPage) => {
    ...
    recharge([phone,beginTime,endTime,currentPage]).then(res => {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo">
                <BreadcrumbCustom first="查询管理" second="用户充值查询" />
                <Row gutter={30}>                  
                  <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card bordered={false} title="用户充值查询" className={'no-padding'}>
                                <div className="gutter-box">
                                  ...
                                  <Row>
                                    <Col md={20} offset={2}>
                                    <p>查询结果：共<span style={{color:'#49a9ee'}}>{this.state.pagination.total}</span>条充值记录</p>
...
const Reg = Form.create()(Recharge);
export default Reg;